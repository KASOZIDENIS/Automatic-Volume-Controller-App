...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        /* renamed from: com.google.android.gms.internal.zzr$zza$zza  reason: collision with other inner class name */
        private static class C0020zza implements zzr {
        ...
        public static zzr zza(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzr)) ? new C0020zza(iBinder) : (zzr) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    AccountChangeEventsResponse zza3 = zza(accountChangeEventsRequest);
                    reply.writeNoException();
                    if (zza3 != null) {
                        reply.writeInt(1);
