...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C0005zza implements zzo {
        ...
        public static zzo zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzo)) ? new C0005zza(iBinder) : (zzo) queryLocalInterface;
        }
