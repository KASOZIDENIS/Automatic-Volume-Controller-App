        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    zza(data.readString(), (List<Scope>) data.createTypedArrayList(Scope.CREATOR), zzf.zza.zzcH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.signin.internal.IOfflineAccessCallbacks");
                    zza(data.readString(), data.readString(), zzf.zza.zzcH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
