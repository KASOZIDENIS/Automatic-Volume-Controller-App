...
public class ToolbarActionBar extends ActionBar {
    ...
    public void populateOptionsMenu() {
        ...
        L_0x0012:
            ...
            android.support.v7.internal.app.WindowCallback r2 = r5.mWindowCallback     // Catch:{ all -> 0x0031 }
            r3 = 0
        ...
        public View onCreatePanelView(int featureId) {
            switch (featureId) {
                case 0:
                    ...
                    if (ToolbarActionBar.this.mWindowCallback != null && ToolbarActionBar.this.mWindowCallback.onPreparePanel(featureId, (View) null, menu) && ToolbarActionBar.this.mWindowCallback.onMenuOpened(featureId, menu)) {
